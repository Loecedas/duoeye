          ...
          return (
            <button
              ...
              className={`group relative aspect-square overflow-hidden rounded-2xl border p-1 transition-transform duration-200 hover:scale-[1.02] min-[768px]:max-[1279px]:aspect-[1/0.82] min-[768px]:max-[1279px]:rounded-[18px] min-[768px]:max-[1279px]:p-0.5 ${
                isUnlocked
                  ? 'border-white/60 shadow-[0_8px_18px_rgba(251,146,60,0.14)] hover:shadow-[0_14px_28px_rgba(251,146,60,0.2)] dark:border-transparent'
      ...
      {selectedAchievement && (
        <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center px-4">
          <div
            ...
            ref={modalRef}
            className="pointer-events-auto w-[260px] animate-scale-in rounded-3xl border border-black/6 bg-[rgba(255,255,255,0.94)] px-5 py-6 text-center shadow-[0_22px_52px_rgba(15,23,42,0.16)] transition-all duration-200 dark:border-transparent dark:bg-[rgba(44,44,46,0.96)]"
          >
            <div
