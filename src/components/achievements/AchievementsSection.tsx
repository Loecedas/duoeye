...
const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'lang_1', title: '语言探索者', description: '学习 1 门语言', icon: '🦉', category: 'special' },
  { id: 'lang_3', title: '多语言者', description: '学习 3 门语言', icon: '🌐', category: 'special' },
  { id: 'lang_5', title: '语言家', description: '学习 5 门语言', icon: '🧭', category: 'special' },
];
...
export default function AchievementsSection({ userData }: AchievementsSectionProps) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-apple-xl border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,249,252,0.94))] p-6 shadow-[0_12px_28px_rgba(15,23,42,0.05)] transition-[transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(15,23,42,0.08)] max-[520px]:p-4 min-[768px]:max-[1023px]:mx-auto min-[768px]:max-[1023px]:max-w-[860px] min-[768px]:max-[1279px]:p-4 min-[768px]:max-[900px]:p-3.5 dark:border-transparent dark:[background-clip:border-box] dark:bg-[linear-gradient(180deg,rgba(58,58,60,0.92),rgba(28,28,30,0.96))] dark:shadow-none dark:hover:shadow-[0_18px_36px_rgba(0,0,0,0.24)]">
      ...
      />
      <div className="mb-4 flex items-center justify-between max-[520px]:mb-3 min-[768px]:max-[1279px]:mb-3 min-[768px]:max-[900px]:mb-2.5">
      ...
      <div className="grid flex-1 grid-cols-5 gap-2 max-[520px]:grid-cols-4 max-[520px]:gap-1.5 md:grid-cols-4 md:gap-2.5 min-[768px]:max-[900px]:grid-cols-4 min-[768px]:max-[900px]:gap-1.5 lg:grid-cols-5 xl:grid-cols-5">
        {allAchievements.map((achievement) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex h-full flex-col items-center justify-center gap-1.5 min-[768px]:max-[900px]:gap-1.5">
                <div className="flex h-[1.6rem] w-[1.9rem] items-center justify-center max-[520px]:h-[1.24rem] max-[520px]:w-[1.44rem] min-[768px]:max-[900px]:h-[1.6rem] min-[768px]:max-[900px]:w-[1.9rem] min-[1024px]:max-[1110px]:h-[1.36rem] min-[1024px]:max-[1110px]:w-[1.64rem]">
                  <EmojiIcon
                    symbol={isUnlocked ? achievement.icon : '🔒'}
                    className={getAchievementCardIconClassName(emojiIconMode)}
                  />
                </div>
                <span className="w-full truncate px-1 text-center text-[9px] font-medium leading-tight text-apple-dark1 max-[520px]:text-[8px] min-[768px]:max-[900px]:text-[9px] min-[1024px]:max-[1110px]:text-[11px] dark:text-white/90">
                  {achievement.title}
                </span>
              </div>
            </button>
